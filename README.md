...
The approach: Instead of asking students what kind of learner they think they are, Calibrate uses a short behavioral onboarding to form a starting hypothesis, then has students test evidence-based techniques (active recall, spaced repetition, the Feynman technique) directly against their coursework — tracking real performance, not self-perception, to surface what actually works per subject.
